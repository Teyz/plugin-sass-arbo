let node = document.querySelectorAll(':not(.tree-menu) > li > *:not(ul)');

var svgNS = 'http://www.w3.org/2000/svg'
let treeMenu = document.querySelector('ul.tree-menu')
...
function traceLine(){
    node.forEach((item, i) => {
        ...
        let newLine = document.createElementNS(svgNS, 'line')
            newLine.setAttributeNS(null, 'stroke-dasharray', '1 5')
